  ...
  const servicesList = [
    {
      ...
      icon: (
        <svg aria-hidden="true" className="w-6 h-6 text-gray-900" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            >
              ...
              <div className="mt-6 pt-4 border-t border-gray-50">
                <button
                  ...
                  aria-label={`Explore ${service.title} plans`}
                  className="inline-flex items-center text-xs font-bold text-[#15803d] hover:text-green-700 transition cursor-pointer"
                >
