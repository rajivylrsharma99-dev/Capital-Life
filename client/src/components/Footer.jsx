  ...
  return (
    <footer className="bg-[#111317] text-gray-400 py-16 border-t border-gray-800">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 mb-12">
          ...
          <div className="lg:col-span-4 flex flex-col space-y-4">
            ...
            <div className="text-xs space-y-2.5">
              ...
              <p className="text-[10px] text-gray-500 font-medium uppercase tracking-wider">Proprietor Capital Life Research</p>
              
              <div className="pt-2 space-y-1.5">
                <p><span className="text-gray-500">SEBI Reg No:</span> <span className="text-white font-medium">INH000022163</span></p>
                <p><span className="text-gray-500">Type:</span> <span className="text-white">Research Analyst</span></p>
                <p><span className="text-gray-500">Email:</span> <a href="mailto:rajivylrsharma89@gmail.com" className="text-[#25a544] hover:underline">rajivylrsharma89@gmail.com</a></p>
                <p><span className="text-gray-500">Phone:</span> <a href="tel:+918109081040" className="text-white hover:text-[#25a544] font-medium">+91 81090 81040</a></p>
              </div>
            </div>
          ...
          <div className="lg:col-span-4 flex flex-col space-y-4">
            ...
            <div className="text-xs space-y-4 leading-relaxed">
              <div>
                <span className="text-gray-500 font-bold block mb-1">Registered Address:</span>
              ...
              <div>
                <span className="text-gray-500 font-bold block mb-1">Correspondence & Previous Address:</span>
                <p className="text-gray-300">
        ...
        <div className="border-t border-gray-850 pt-8 flex flex-col sm:flex-row justify-between items-center text-[10px] text-gray-600 gap-4">
          <div>
