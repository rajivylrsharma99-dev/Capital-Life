    ...
    <div className="bg-[#fcfdfe] min-h-screen py-16">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div id="plans" className="text-center max-w-3xl mx-auto mb-20 scroll-mt-24">
          <span className="text-xs font-bold text-gray-600 uppercase tracking-widest block mb-2">PRICING PACKAGES</span>
          ...
          <div className="bg-white rounded-[24px] border border-gray-200 p-8 shadow-sm flex flex-col justify-between hover:shadow-md transition duration-300">
            <div>
              ...
              <div className="flex justify-between items-start mb-6">
                <div>
                  <span className="text-[10px] font-bold text-[#15803d] bg-[#25a544]/10 py-1 px-2.5 rounded-md uppercase tracking-wider mb-2 inline-block">PORTFOLIO</span>
                  <h3 className="text-xl font-bold text-gray-900 tracking-tight">ALPHA INDIA</h3>
                  <span className="text-xs text-gray-600">Best stocks for 2026</span>
                </div>
              ...
              {/* Features List */}
              <div className="mb-8">
                <span className="text-[9px] font-bold text-gray-600 uppercase tracking-widest block mb-4">
                  KEY FEATURES
                </span>
                <ul className="space-y-3.5">
                  <li className="flex items-center text-xs text-gray-600 leading-relaxed">
                    <svg aria-hidden="true" className="w-4 h-4 text-green-500 mr-2 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div className="space-y-4">
              ...
              >
                ...
                >
                  ...
                  <span className="text-right">
                    <span className="text-[10px] text-gray-600 line-through block font-medium">₹22,000</span>
              ...
              >
                ...
                >
                  ...
                  <span className="text-right">
                    <span className="text-[10px] text-gray-600 line-through block font-medium">₹44,000</span>
            ...
            <div>
              ...
              <div className="flex justify-between items-start mb-6">
                <div>
                  ...
                  <span className="text-xs text-gray-600">Mid-term investing focus</span>
                </div>
            ...
            <div>
              ...
              <div className="flex justify-between items-start mb-6">
                <div>
                  ...
                  <span className="text-xs text-gray-600">Alpha India + Multibagger</span>
                </div>
            ...
            <div className="space-y-4">
              ...
              >
                ...
                >
                  <span className="text-xs font-bold text-gray-800">12 Months</span>
                  <span className="text-right">
                    <span className="text-[10px] text-gray-600 line-through block font-medium">₹84,000</span>
        ...
        <div id="callback-form" className="bg-[#f1f5f9] rounded-[32px] p-8 md:p-14 mb-10 shadow-sm border border-gray-200">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            
            {/* Left Column info */}
            <div className="lg:col-span-5 space-y-6">
              <span className="text-xs font-bold text-[#15803d] uppercase tracking-widest block">CONNECT WITH US</span>
              ...
              <div className="flex items-center space-x-4 pt-6 border-t border-gray-250">
                ...
                <div>
                  <span className="text-[10px] text-gray-600 uppercase tracking-widest block font-bold leading-none mb-1">CALL US DIRECTLY</span>
                  <a href="tel:+918109081040" className="text-xl font-bold text-gray-950 hover:text-[#15803d] transition">
                    +91 81090 81040
                  </a>
                </div>
              </div>
              ...
              <div className="bg-white rounded-2xl p-6 sm:p-10 shadow-lg border border-gray-200">
                ...
                {formSubmitted ? (
                  ...
                  <form onSubmit={handleFormSubmit} className="space-y-5">
                    <div>
                      <label htmlFor="fullName" className="block text-xs font-bold text-gray-600 mb-2 uppercase tracking-wide">Full Name</label>
                      <input
                        id="fullName"
                        type="text"
                        required
                    ...
                    <div>
                      <label htmlFor="emailAddress" className="block text-xs font-bold text-gray-600 mb-2 uppercase tracking-wide">Email Address</label>
                      <input
                        id="emailAddress"
                        type="email"
                        required
                    ...
                    <div>
                      <label htmlFor="mobileNumber" className="block text-xs font-bold text-gray-600 mb-2 uppercase tracking-wide">Mobile Number</label>
                      <div className="flex">
                        <span className="inline-flex items-center px-4 rounded-l-xl border border-r-0 border-gray-250 bg-gray-50 text-gray-600 text-sm font-semibold">
                          +91
                        </span>
                        <input
                          id="mobileNumber"
